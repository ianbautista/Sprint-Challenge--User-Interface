...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   ...
   Semantic HTML gives meaning to the elements for the browser to understand your html structures better. It improves accessibility and SEO.
...
4. Explain why git is valuable to a team of developers.
   ...
   Git is important because it gives you the ability to go back in time and see prevoius versions of your code if theres a need to debug/fix/update your project. It also helps with collaboration with teams using cloud-based flatforms like github to simultaneaously work on a specific project.

5. Define mobile-first design in your own words.

   Mobile first design is an approach which developers/designers start developing projects by designing on mobile screen first then later on design up to larger screens.
